...
const Monthly_pick_lines = () => {
    ...
    const {
        ...
        () => {
            return axios({
                method: "post",
                url: `https://erp.proconnect.in/Unifiedportal/api/v1/pklinecount?typ=${values?.type}`,
                headers: {
        ...
        <div className='alchart'>
            <div>
                <ContentHeader
                    ...
                    ></img>}
                    Subtitle={"Monthly Pick Lines"}
                    Arrow={false}
                    FilterSLA={true}
                    page={"MonthlyPickLines"}
                    Period={false}
                    // Filter={true}
                    Download={false}
                    InfoIcon={false}
            ...
            <div className='al-line-chart'>
                <div>
                    <LineChart lineData={data} lineOptions={options} loader={loader} selectedType={values} page={"1"} />
                </div>
            </div>
        </div>
    )
...
export default Monthly_pick_lines
